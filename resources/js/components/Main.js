...
class Main extends Component{
  ...
  componentDidMount() {
    axios.get('http://localhost:4000/api/thongkes/')
      .then(res => {
        this.setState({
          thongkes: res.data
        });
                        ...
                        <div className="row">
                          <div className="col-sm-12">
                            <div className="statistics-details d-flex align-items-center justify-content-between">
                              <div>
                                <p className="statistics-title">Tin tức</p>
                                <h3 className="rate-percentage">{this.state.thongkes[0]}</h3>
                                </div>
                              <div>
                                <p className="statistics-title">Đối tác</p>
                                <h3 className="rate-percentage">{this.state.thongkes[1]}</h3>
                               </div>
                              <div>
                                <p className="statistics-title">Người đăng ký</p>
                                <h3 className="rate-percentage">{this.state.thongkes[2]}</h3>
                                </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Người ủng hộ</p>
                                <h3 className="rate-percentage">{this.state.thongkes[25]}</h3>
                               </div>
                                  ...
                                  <div className="card-body">
                                    <div className="d-sm-flex justify-content-between align-items-start">
                                      <div>
                                        ...
                                        <div className="d-sm-flex align-items-center mt-4 justify-content-between"><h2 className="me-2 fw-bold">$ {this.state.thongkes[10]}</h2><h4 className="me-2"></h4><h4 className="text-success">(+0.00%)</h4></div>
                                         </div>
                              ...
                              <div className="col-md-6 col-lg-12 grid-margin stretch-card">
                                <div className="card bg-primary card-rounded">
                                  <div className="card-body pb-0">
                                    <h4 className="card-title card-title-dash text-white mb-4">Tổng tiền ngày hôm nay</h4>
                                    <div className="row">
                                      <div className="col-sm-12">
                                        <h1>{this.state.thongkes[24]}</h1>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="card card-rounded">
                                  <div className="card-body">
                                    ...
                                    <div className="d-sm-flex align-items-center mt-1 justify-content-between">
                                      <div className="d-sm-flex align-items-center mt-4 justify-content-between"><h2 className="me-2 fw-bold">$ {this.state.thongkes[23]}</h2><h4 className="me-2"></h4><h4 className="text-success">(+0.00%)</h4></div>
